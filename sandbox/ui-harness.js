import { DevToolsWindow } from '../src/ui.js?v=0.16.6';
...
const sandboxOnboardingHook = Object.freeze({
    ...
    enterPractice() {
        const entered = devTools.onboardingStepStage === 'practice'
            || (
                devTools.onboardingStepStage === 'briefing'
